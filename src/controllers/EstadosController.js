...
const llavePrimaria = Estado.primaryKeyAttributes[0] || '';

export const getAll = (req, res) => Estado.findAll().then(items => res.json(items)).catch(err => ErrorHandler(err, res));

export const create = (req, res) => {
    return Estado.create(req.body).then(item => {
